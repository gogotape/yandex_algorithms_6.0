from homework2.taskH.taskH import (calc_min_numbers_of_transitions, dummy,
                                   calc_min_numbers_of_transitions_v2)
...
def test_taskH():
    ...
    assert calc_min_numbers_of_transitions_v2(cabinets) == 10

    cabinets = [5, 4, 3, 2, 1]
    assert dummy(cabinets) == 15
    assert calc_min_numbers_of_transitions(cabinets) == 15
    assert calc_min_numbers_of_transitions_v2(cabinets) == 15
    ...
    assert calc_min_numbers_of_transitions_v2(cabinets) == 0
